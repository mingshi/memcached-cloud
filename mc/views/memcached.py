...
def memcached_detail(memcached_id) :
    ...
    stats_description['total_items'] = u'总共的item数量'
    stats_description['uptime'] = u'服务启动的时间，单位为秒'
    stats_description['limit_maxbytes'] = u'服务启动内存大小'
    stats_description['rusage_user'] = u''
    stats_description['bytes_read'] = u'读取的流量'
    stats_description['rusage_system'] = u''
    stats_description['cmd_get'] = u'get次数'
    stats_description['curr_connections'] = u'当前的连接数'
    stats_description['threads'] = u'进程数'
    stats_description['total_connections'] = u''
    stats_description['cmd_set'] = u'set次数'
    stats_description['curr_items'] = u''
    ...
    stats_description['bytes_written'] = u'写入的流量'
